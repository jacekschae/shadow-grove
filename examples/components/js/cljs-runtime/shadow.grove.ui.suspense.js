...
if(cljs.core.truth_((function (){var and__5023__auto__ = self__.should_trigger_QMARK_;
...
(shadow.grove.ui.suspense.SuspenseScheduler.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"shadow.grove.ui.suspense/SuspenseScheduler");
}));
...
if(cljs.core.truth_((function (){var and__5023__auto__ = self__.offscreen;
if(cljs.core.truth_(and__5023__auto__)){
...
var offscreen_env = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.parent_env,new cljs.core.Keyword("shadow.grove","scheduler","shadow.grove/scheduler",905620149),scheduler);
...
var self__ = this;
var this$ = this;
var temp__5827__auto__ = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(self__.opts);
...
var temp__5827__auto___8869 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(self__.opts);
if((temp__5827__auto___8869 == null)){
} else {
var key_8870 = temp__5827__auto___8869;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("shadow.grove.ui.suspense","suspense-keys","shadow.grove.ui.suspense/suspense-keys",178486569).cljs$core$IFn$_invoke$arity$1(self__.parent_env),cljs.core.dissoc,key_8870);
}
...
(shadow.grove.ui.suspense.SuspenseRoot.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"shadow.grove.ui.suspense/SuspenseRoot");
}));
...
var self__ = this;
var this$__$1 = this;
var G__8837 = (new shadow.grove.ui.suspense.SuspenseRoot(self__.opts,self__.vnode,shadow.arborist.common.dom_marker.cljs$core$IFn$_invoke$arity$1(env),env,new cljs.core.Keyword("shadow.grove","scheduler","shadow.grove/scheduler",905620149).cljs$core$IFn$_invoke$arity$1(env),null,null,null,null,false));
G__8837.init_BANG_();
...
(shadow.grove.ui.suspense.SuspenseInit.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"shadow.grove.ui.suspense/SuspenseInit");
}));
