...
var i_12697 = (0);
while(true){
if((i_12697 < arr.length)){
(arr[i_12697] = null);

var G__12704 = (i_12697 + (1));
i_12697 = G__12704;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_12797 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12797[i]));
} else {
x__$2.forward.push((((i < links_12797.length))?(links_12797[i]):null));
}

if((i < links_12797.length)){
(links_12797[i] = x__$2);
} else {
links_12797.push(x__$2);
}
...
var i_12837 = (0);
while(true){
if((i_12837 <= self__.level)){
var links_12838 = (update[i_12837]).forward;
if((x__$1 === (((i_12837 < links_12838.length))?(links_12838[i_12837]):null))){
(links_12838[i_12837] = (x__$1.forward[i_12837]));

var G__12843 = (i_12837 + (1));
i_12837 = G__12843;
continue;
} else {
var G__12844 = (i_12837 + (1));
i_12837 = G__12844;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__12867 = nx;
var G__12868 = (level__$1 - (1));
x = G__12867;
level__$1 = G__12868;
continue;
} else {
var G__12869 = x;
var G__12870 = (level__$1 - (1));
x = G__12869;
level__$1 = G__12870;
continue;
}
