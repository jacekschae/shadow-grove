...
return (shadow.arborist.attributes.attr_handlers[kw.fqn] = handler);
});
...
shadow.arborist.attributes.maybe_wrap_ev_fn = (function shadow$arborist$attributes$maybe_wrap_ev_fn(ev_fn,m,ev_opts){
var map__7759 = m;
var map__7759__$1 = cljs.core.__destructure_map(map__7759);
var capture = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","capture","e/capture",-677031226));
var signal = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","signal","e/signal",-1984951554));
var prevent_default = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","prevent-default","e/prevent-default",813416704));
var rate_limit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","rate-limit","e/rate-limit",1748081857));
var debounce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","debounce","e/debounce",-871550403));
var stop_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","stop!","e/stop!",726634536));
var passive = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","passive","e/passive",252884107));
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","stop","e/stop",-2140915081));
var once = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","once","e/once",-262568708));
var throttle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7759__$1,new cljs.core.Keyword("e","throttle","e/throttle",-1860340685));
...
(ev_opts["passive"] = true);
} else {
}

if(cljs.core.truth_(capture)){
(ev_opts["capture"] = true);
} else {
}
...
var G__7761 = ev_fn;
var G__7761__$1 = (cljs.core.truth_(debounce)?goog.functions.debounce(G__7761,debounce):G__7761);
var G__7761__$2 = (cljs.core.truth_(throttle)?goog.functions.throttle(G__7761__$1,throttle):G__7761__$1);
var G__7761__$3 = (cljs.core.truth_(rate_limit)?goog.functions.rateLimit(G__7761__$2,rate_limit):G__7761__$2);
var G__7761__$4 = (cljs.core.truth_(prevent_default)?shadow.arborist.attributes.wrap_prevent_default(G__7761__$3):G__7761__$3);
var G__7761__$5 = (cljs.core.truth_(stop)?shadow.arborist.attributes.wrap_stop(G__7761__$4):G__7761__$4);
if(cljs.core.truth_(stop_BANG_)){
return shadow.arborist.attributes.wrap_stop_BANG_(G__7761__$5);
} else {
return G__7761__$5;
}
});
...
return (function (env,node,oval,nval){
var temp__5823__auto___7818 = (node[ev_key]);
if(cljs.core.truth_(temp__5823__auto___7818)){
var ev_fn_7819 = temp__5823__auto___7818;
node.removeEventListener(event,ev_fn_7819);
} else {
}

if((!((nval == null)))){
if(cljs.core.fn_QMARK_(nval)){
return node.addEventListener(event,(function (e){
return (nval.cljs$core$IFn$_invoke$arity$2 ? nval.cljs$core$IFn$_invoke$arity$2(e,env) : nval(e,env));
}));
} else {
...
var ev_opts = ({});
var ev_fn__$1 = (((!(cljs.core.map_QMARK_(nval))))?ev_fn:shadow.arborist.attributes.maybe_wrap_ev_fn(ev_fn,nval,ev_opts));
node.addEventListener(event,ev_fn__$1,ev_opts);

return (node[ev_key] = ev_fn__$1);
}
} else {
return null;
}
...
return (function (env,node,oval,nval){
if((shadow.arborist.protocols.svg_ns === node.namespaceURI)){
return shadow.arborist.attributes.set_dom_attribute(node,key.name,nval);
} else {
return (node[prop] = nval);
}
});
...
var handler = (shadow.arborist.attributes.attr_handlers[key.fqn]);
if(handler){
return handler(env,node,oval,nval);
} else {
var handler__$1 = shadow.arborist.attributes.make_attr_handler(key);
(shadow.arborist.attributes.attr_handlers[key.fqn] = handler__$1);
...
shadow.arborist.attributes.add_attr(new cljs.core.Keyword(null,"form","form",-1624062471),(function (env,node,oval,nval){
return shadow.arborist.attributes.set_dom_attribute(node,"form",nval);
}));
shadow.arborist.attributes.add_attr(new cljs.core.Keyword(null,"list","list",765357683),(function (env,node,oval,nval){
return shadow.arborist.attributes.set_dom_attribute(node,"list",nval);
}));
...
return shadow.arborist.attributes.set_style_property(node,cljs.core.name(k),v);
}),null,nval);

if(cljs.core.map_QMARK_(oval)){
return cljs.core.reduce_kv((function (_,k,v){
if(cljs.core.contains_QMARK_(nval,k)){
return null;
} else {
return shadow.arborist.attributes.set_style_property(node,cljs.core.name(k),null);
}
}),null,oval);
} else {
return null;
...
var sval = (((nval == null))?"":((typeof nval === 'string')?nval:((cljs.core.vector_QMARK_(nval))?(function (){var temp__5821__auto__ = shadow.arborist.attributes.vec__GT_class(nval);
...
})():((cljs.core.map_QMARK_(nval))?(function (){var temp__5821__auto__ = shadow.arborist.attributes.map__GT_class(nval);
if(cljs.core.truth_(temp__5821__auto__)){
var s = temp__5821__auto__;
return s;
} else {
...
if(cljs.core.truth_((function (){var and__5023__auto__ = oval;
...
shadow.arborist.attributes.add_attr(new cljs.core.Keyword("dom","inner-html","dom/inner-html",1794195536),(function (env,node,oval,nval){
if(cljs.core.seq(nval)){
return (node.innerHTML = nval);
} else {
return null;
}
}));
